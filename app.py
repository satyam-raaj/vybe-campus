...
@media (max-width:850px){
  ...
  .student-bottom-nav .mobile-profile-nav{order:1}
  .student-bottom-nav .mobile-home-nav{order:2}
  .student-bottom-nav .mobile-menu-nav{order:3}
