...
CSS = r"""
:root{--bg:#000;--bg2:#0b0b0f;--panel:#111114;--panel2:#18181c;--line:rgba(255,255,255,.10);--line2:rgba(255,255,255,.18);--text:#f5f5f7;--muted:#98989f;--good:#30d158;--warn:#ffd60a;--bad:#ff453a;--shadow:0 18px 55px rgba(0,0,0,.34)}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--bg);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","SF Pro Text","Segoe UI",sans-serif;min-height:100vh;letter-spacing:-.012em}a{text-decoration:none;color:inherit}.nav{position:sticky;top:0;z-index:50;background:rgba(0,0,0,.78);backdrop-filter:saturate(180%) blur(24px);-webkit-backdrop-filter:saturate(180%) blur(24px);border-bottom:1px solid var(--line)}.navin{max-width:1180px;margin:auto;padding:14px 20px;display:flex;align-items:center;justify-content:space-between;gap:14px}.brand{font-weight:800;letter-spacing:-.055em;font-size:23px}.brandmark{display:inline-grid;place-items:center;width:31px;height:31px;margin-right:8px;border-radius:10px;background:#f5f5f7;color:#050505;font-size:14px;font-weight:900}.navlinks{display:flex;gap:5px;flex-wrap:wrap}.navlinks a{padding:9px 12px;border-radius:999px;color:#a1a1a6;font-size:13px;transition:background .2s,color .2s}.navlinks a:hover{background:#1c1c20;color:#fff}.wrap{max-width:1180px;margin:auto;padding:28px 20px 80px}.hero{min-height:68vh;display:grid;place-items:center;text-align:center;padding:80px 0 50px}.hero h1{font-size:clamp(76px,14vw,155px);line-height:.8;margin:18px 0;letter-spacing:-.1em;background:linear-gradient(180deg,#fff,#b8b8be 55%,#55555d);-webkit-background-clip:text;background-clip:text;color:transparent}.hero p{max-width:690px;color:var(--muted);font-size:18px;line-height:1.6;margin:0 auto 28px}.badge,.pill{display:inline-block;border:1px solid var(--line);background:#111114;padding:7px 11px;border-radius:999px;color:#c7c7cc;font-size:12px}.grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}.grid2{display:grid;grid-template-columns:repeat(2,1fr);gap:16px}.card{background:linear-gradient(145deg,#17171b,#0d0d10);border:1px solid var(--line);border-radius:24px;padding:23px;box-shadow:var(--shadow);transition:transform .25s,border-color .25s,background .25s;animation:fadeUp .4s ease both}.card:hover{transform:translateY(-2px);border-color:var(--line2);background:linear-gradient(145deg,#1b1b20,#101014)}.card h2,.card h3{margin:0 0 9px;letter-spacing:-.035em}.muted{color:var(--muted)}.small{font-size:13px;color:var(--muted)}.btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;border:1px solid transparent;cursor:pointer;padding:11px 17px;border-radius:999px;background:#f5f5f7;color:#080808;font-weight:700;transition:transform .2s,background .2s,opacity .2s;box-shadow:none}.btn:hover{transform:translateY(-1px);background:#fff}.btn:active{transform:scale(.98)}.btn:disabled{opacity:.45;cursor:not-allowed;transform:none}.btn.dark{background:#1c1c20;color:#fff;border-color:#303037}.btn.dark:hover{background:#28282e}.btn.good{background:rgba(48,209,88,.12);color:#6ee787;border-color:rgba(48,209,88,.28)}.btn.danger{background:rgba(255,69,58,.12);color:#ff8b84;border-color:rgba(255,69,58,.28)}.btn.accent{background:#f5f5f7;color:#080808}.actions{display:flex;gap:9px;flex-wrap:wrap;margin-top:16px}.section{padding:30px 0}.auth{min-height:80vh;display:grid;place-items:center}.authbox{width:min(470px,100%)}.form{display:grid;gap:13px}.label{font-size:13px;color:#b5b5bb;margin-bottom:5px}input,textarea,select{width:100%;padding:13px 14px;background:#101014;color:#fff;border:1px solid #303037;border-radius:14px;outline:none;transition:border-color .2s,background .2s,box-shadow .2s}input::placeholder,textarea::placeholder{color:#66666e}input:focus,textarea:focus,select:focus{border-color:#8e8e96;background:#151519;box-shadow:0 0 0 4px rgba(255,255,255,.06)}textarea{min-height:125px;resize:vertical}.flash{padding:13px 15px;border:1px solid #303037;background:#151519;border-radius:15px;margin:10px 0}.two{display:grid;grid-template-columns:1fr 1fr;gap:16px}table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:12px 9px;border-bottom:1px solid #29292e;vertical-align:top}.tablewrap{overflow:auto}.kpi{font-size:38px;font-weight:850;letter-spacing:-.065em}.footer{padding:50px 0;color:#5f5f67;text-align:center}.empty{text-align:center;padding:45px;color:var(--muted);border:1px dashed #303037;border-radius:20px}.status-good,.online{color:var(--good)}.status-warn{color:var(--warn)}.status-bad,.offline{color:var(--bad)}.icon{font-size:27px;margin-bottom:12px}.resource-meta{display:flex;gap:7px;flex-wrap:wrap;margin:10px 0}.danger-zone{border-color:#5a252d}.notice{padding:16px;border-radius:17px;background:#121216;border:1px solid var(--line);line-height:1.55}.chat{display:grid;gap:9px;margin-top:15px}.bubble{padding:13px 15px;border-radius:17px;background:#121216;border:1px solid #29292f}.mine{border-color:#414149}.offline-page{min-height:78vh;display:grid;place-items:center;text-align:center}.offline-page h1{font-size:clamp(48px,8vw,92px);letter-spacing:-.07em;margin:12px 0}@keyframes fadeUp{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:none}}@media(max-width:850px){.grid,.grid2,.two{grid-template-columns:1fr}.navlinks{display:none}.wrap{padding:18px 15px 65px}.hero{padding:55px 0 35px}.hero h1{font-size:74px}.card{border-radius:21px}}
"""
